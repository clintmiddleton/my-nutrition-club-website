    ...
    <div class="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">
          Ready to transform your nutrition club?
        </h2>
        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-primary-200">
          Join hundreds of nutrition professionals who trust MyNutritionClub to grow their business
          and help their clients succeed.
        </p>
