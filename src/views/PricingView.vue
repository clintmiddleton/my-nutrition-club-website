    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl sm:text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
          Simple pricing for every nutrition club
        </h2>
        <p class="mt-6 text-lg leading-8 text-gray-600">
          Choose the plan that's right for your business. Start with our free trial and upgrade as
          you grow.
        </p>
      </div>
      <div
      ...
      >
        <div class="p-8 sm:p-10 lg:flex-auto">
          <h3 class="text-2xl font-bold tracking-tight text-gray-900">Professional Plan</h3>
          <p class="mt-6 text-base leading-7 text-gray-600">
            Everything you need to manage your nutrition club and help your clients succeed.
          </p>
        ...
        <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
          ...
          >
            <div class="mx-auto max-w-xs px-8">
              <p class="text-base font-semibold text-gray-600">Pay monthly</p>
